...
*/
const A187 = '☠︎︎MR02☠︎︎'; // JANGAN UBAH-UBAH INFO!!!
const instagram = 'https://instagram.com/moch_rizky31.ig'; // JANGAN UBAH-UBAH INFO!!!
const nomer = 'Wa.me/+6283808215556'; // JANGAN UBAH-UBAH INFO!!!
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] MR02 ready scan now!`);
});
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @_moch_rizky31.ig`)
})
...
conn.sendMessage(id, ' *Owner MR02 wa.me/+6283808215556* ' ,MessageType.text);
}
else if (text == '®creator'){
conn.sendMessage(id, ' *Creator MR02 wa.me/+6283808215556* ' ,MessageType.text);
}
else if (text == 'Pagi'){
...
//Tolonglah bro jangan di ubah ubah MR02 ID
